    ...
    return (
      <span ref="wrapper" class={bem('wrapper')} onClick={this.onClickWrapper}>
        <Popup
          ...
          overlay={this.stopOnceOnClick?true:this.overlay}
          overlayClass={ this.stopOnceOnClick?bem('popover-stoponcepopup'): ''}
          position={null}
          transition="bvan-popover-zoom"
          lockScroll={false}
        ...
        >
          <div class={bem('arrow')} style={this.arrowStyle} />
